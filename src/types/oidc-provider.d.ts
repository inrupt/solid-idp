...
declare class Provider extends EventEmitter {
  ...
  interactionDetails(ctx: Context): Promise<Provider.Session>;
  // TODO: provide a type for the configuration of interaction finished and check to be sur
  interactionFinished(req: IncomingMessage | Http2ServerRequest, res: ServerResponse | Http2ServerResponse, Provider.InteractionResult): Promise<void>;
  interactionResult(req: IncomingMessage | Http2ServerRequest, res: ServerResponse | Http2ServerResponse, Provider.InteractionResult): Promise<string>;
  ...
  registerResponseMode(name: string, handler: (ctx: Context, redirectUri: string, payload: {}) => void): void;
...
declare namespace Provider {
  ...
  class Adapter {
    ...
    upsert(id: string, payload: {}, expiresIn: number): Promise<void>
  ...
  interface ProviderConfiguration {
    adapter?: Adapter
    clients?: Client[]
    findAccount?: (ctx: Context, sub: string, token?: string) => Account
    jwks?: JWKSet
    features?: {
